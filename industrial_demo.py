...
from aip_jep.models import OperationType, RiskLevel
import json

def run_demo():    
    # 1. 初始化验证器 (模拟 sidecar 启动)
    verifier = AIPJudgmentVerifier()    
    print(f"🚀 JEP Sidecar Started.")    
    ...
    mock_context = {        
        ...
        "policy_uri": "https://specs.jep-protocol.org/policies/v1/production-safety.jep",        
